...
// this refers the to an instance of the object (joe.scope)
//
// 2. What is "this" when joe.scopeArrow() is invoked?
// undifined
//
// 3. Explain why "this" is different when an arrow function is used.
//  the arrow function follow the normal varable lookup  it will not find this in the current scopearrow .
//
